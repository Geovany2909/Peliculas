...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb rounded-pill">
        ...
        <li class="breadcrumb-item active" aria-current="page">Editando pelicula: <mark> {{ $pelicula->nombre }}</mark></li>
    </ol>
</nav>
@endsection
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="text" name="nombre" class="form-control" id="name"
                                            placeholder="Nombre de la pelicula" value="{{ old('name', $pelicula->nombre) }}">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <select name="categoria_id" id="categoria_id" class="form-control" required>
                                            <option value="{{ $pelicula->categoria->id}}">
                                                {{ $pelicula->categoria->nombre }}
                                            </option>
                                            @foreach ($categorias as $item)
                                                @if ($pelicula->categoria()->first()->id != $item->id)
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="number" value="{{ old('precioVenta', $pelicula->precioVenta) }}" name="precioVenta" id="precioVenta"
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="number" name="existencias" value="{{ $pelicula->existencias }}" id="existencias" class=" form-control"
                                ...
                                <div class="col-md-6 form-group ">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <textarea class="form-control" name="descripcion" id="label-textarea" rows="3"
                                            placeholder="Descripción">{{ old('descripcion', $pelicula->descripcion) }}</textarea>
                                        <div class="form-control-position">
                                            <i class="bx bx-notepad" id="view-icon"></i>
                                        </div>
                                    </div>
